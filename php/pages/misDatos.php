                            ...
                            <fieldset>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select rounded-pill py-3" id="ubi" name="localidad" required
                                        ...
                                        <option value="Yerba Buena" <?php echo ($localidad == "Yerba Buena") ? "selected" : ""; ?>>
                                            Yerba Buena</option>
                                        <option value="Aguilares" <?php echo ($localidad == "Aguilares") ? "selected" : ""; ?>>
                                            Aguilares</option>
                                        <option value="Alderetes" <?php echo ($localidad == "Alderetes") ? "selected" : ""; ?>>
                                            Alderetes</option>
                                        <option value="Banda del Río Salí" <?php echo ($localidad == "Banda del Río Salí") ? "selected" : ""; ?>>Banda del Río Salí</option>
                                        <option value="Bella Vista" <?php echo ($localidad == "Bella Vista") ? "selected" : ""; ?>>
                                            Bella Vista</option>
                                        <option value="Burruyacú" <?php echo ($localidad == "Burruyacú") ? "selected" : ""; ?>>
                                            Burruyacú</option>
                                        <option value="Concepción" <?php echo ($localidad == "Concepción") ? "selected" : ""; ?>>
                                            Concepción</option>
                                        <option value="Famaillá" <?php echo ($localidad == "Famaillá") ? "selected" : ""; ?>>Famaillá
                                        </option>
                                        <option value="Graneros" <?php echo ($localidad == "Graneros") ? "selected" : ""; ?>>Graneros
                                        </option>
                                        <option value="Juan Bautista Alberdi" <?php echo ($localidad == "Juan Bautista Alberdi") ? "selected" : ""; ?>>Juan Bautista Alberdi</option>
                                        <option value="La Cocha" <?php echo ($localidad == "La Cocha") ? "selected" : ""; ?>>La Cocha
                                        </option>
                                        <option value="Las Talitas" <?php echo ($localidad == "Las Talitas") ? "selected" : ""; ?>>Las
                                            Talitas</option>
                                        <option value="Lules" <?php echo ($localidad == "Lules") ? "selected" : ""; ?>>Lules</option>
                                        <option value="Monteros" <?php echo ($localidad == "Monteros") ? "selected" : ""; ?>>Monteros
                                        </option>
                                        <option value="Simoca" <?php echo ($localidad == "Simoca") ? "selected" : ""; ?>>Simoca
                                        </option>
                                        <option value="Tafí del Valle" <?php echo ($localidad == "Tafí del Valle") ? "selected" : ""; ?>>Tafí del Valle</option>
                                        <option value="Tafí Viejo" <?php echo ($localidad == "Tafí Viejo") ? "selected" : ""; ?>>Tafí
                                            Viejo</option>
                                        <option value="Trancas" <?php echo ($localidad == "Trancas") ? "selected" : ""; ?>>Trancas
                                        </option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label for="cel" class="form-label">Tel/Cel</label>
                                    <input type="number" class="form-control rounded-pill py-3" min="1000000" max="999999999999999"
                                        name="telefono" id="cel" value="<?php echo $cel; ?>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Email</label>
                                    <input type="email" class="form-control rounded-pill py-3" name="email" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="<?php echo $correo; ?>" required>
                                </div>
                                <div class="mb-3">
